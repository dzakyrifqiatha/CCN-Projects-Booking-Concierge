...
CustomKeywords.'ccnpackage.UnorderedListNumber.uploadFile'(findTestObject('Page_Create New Booking/span_Add file'), 'D:\\Works\\Cargo Community Network Pte Ltd\\Apps\\Booking Concierge\\Sprint 1\\Test Result from Karen\\invalid password.doc')
...
WebUI.click(findTestObject('Page_Create New Booking/Page_Save Booking/button_Record  Template Booking'))

WebUI.setText(findTestObject('Page_Create New Booking/Page_Save Booking/input_Template Code_mat-input-17'), 'Template004')

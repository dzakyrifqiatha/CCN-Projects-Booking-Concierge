...
WebUI.setText(findTestObject('Page_Create New Booking/input_-_mat-input-AWB Suffix'), '9837593')
...
WebUI.setText(findTestObject('Page_Create New Booking/input__mat-input-Weight'), '3324')

WebUI.setText(findTestObject('Page_Create New Booking/input__mat-input-Volume'), '111')

WebUI.setText(findTestObject('Page_Create New Booking/input_Special Handling Codes 1'), 'ASD')
...
WebUI.setText(findTestObject('Page_Create New Booking/input__mat-input-Flight Number'), '7434')

WebUI.setText(findTestObject('Page_Create New Booking/input__mat-input-Flight Date'), '20-May-20')

WebUI.setText(findTestObject('Page_Create New Booking/input__mat-input-Board Point'), 'QWE')

WebUI.setText(findTestObject('Page_Create New Booking/input__mat-input-Off Point'), 'ZXC')
...
WebUI.setText(findTestObject('Page_Create New Booking/input_Volume_mat-input-Width'), '121')
...
WebUI.setText(findTestObject('Page_Create New Booking/input_Volume_mat-input-Weight'), '1000')
...
WebUI.setText(findTestObject('Page_Create New Booking/textarea_Remarks_Booking'), 'Test New Booking with Attachment')

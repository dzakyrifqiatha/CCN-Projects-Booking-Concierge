...
def static "ccnpackage.clickUsingJS.clickUsingJS"(
    	TestObject to	
     , 	int timeout	) {
    (new ccnpackage.clickUsingJS()).clickUsingJS(
        	to
         , 	timeout)
}
...
def static "ccnpackage.Searchlistandclick.selectValueFromUnorderedList"(
    	TestObject unorderedList	
     , 	String value	) {
    (new ccnpackage.Searchlistandclick()).selectValueFromUnorderedList(
        	unorderedList
         , 	value)
}
...
def static "ccnpackage.UnorderedListnumber.selectValueFromUnorderedList"(
    	TestObject unorderedList	
     , 	Number value	) {
    (new ccnpackage.UnorderedListnumber()).selectValueFromUnorderedList(
        	unorderedList
         , 	value)
}

def static "ccnpackage.UnorderedListnumber.uploadFile"(
    	TestObject to	
     , 	String filePath	) {
    (new ccnpackage.UnorderedListnumber()).uploadFile(
        	to
         , 	filePath)
}

def static "ccnpackage.UploadFile.uploadFile"(
    	TestObject to	
     , 	String filePath	) {
    (new ccnpackage.UploadFile()).uploadFile(
        	to
         , 	filePath)
}

def static "ccnpackage.LogResults.searchresult"(
    	String Msg	
     , 	String Mark	) {
    (new ccnpackage.LogResults()).searchresult(
        	Msg
         , 	Mark)
}

def static "ccnpackage.ccnkeywords.selectValueFromUnorderedList"(
    	TestObject unorderedList	
     , 	String value	) {
    (new ccnpackage.ccnkeywords()).selectValueFromUnorderedList(
        	unorderedList
         , 	value)
}

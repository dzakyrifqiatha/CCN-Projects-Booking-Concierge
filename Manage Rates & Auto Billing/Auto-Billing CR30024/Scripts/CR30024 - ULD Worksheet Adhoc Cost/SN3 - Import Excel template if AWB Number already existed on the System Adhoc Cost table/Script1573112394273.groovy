...
WebUI.click(findTestObject('Landing_Page/div_myAppRMS3 - PPD'))
...
WebUI.verifyElementNotChecked(findTestObject('Page_Manage Rates/2 Adhoc Quotation/Import/checkbox_Overwrite Existing Record'), 
    0)

CustomKeywords.'ccnpackage.UploadFile.uploadFile'(findTestObject('Page_Manage Rates/2 Adhoc Quotation/Import/btn_Browse File'), 
    'D:\\Works\\Cargo Community Network Pte Ltd\\Documents\\AutoBilling + ManageRates\\CR30024_CR30025\\CR30024\\Test Data\\v2\\CR30024_25_TestData13.xlsx')

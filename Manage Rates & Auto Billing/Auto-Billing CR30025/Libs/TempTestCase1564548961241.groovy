...
RunConfiguration.setExecutionSettingFile('C:\\Users\\kohcj\\AppData\\Local\\Temp\\Katalon\\Test Cases\\AB CR30043\\1 Insert New Shipment\\SN1_Insert New Shipment with Flight Number is 3 Character (3 Digits)\\20190731_125601\\execution.properties')
...
not_run: WebUI.sendKeys(findTestObject('Page_Auto-Billing/Page_Shipment Details/Add Record/ShipperCountryCode_input'), Keys.chord(
        Keys.DELETE), FailureHandling.CONTINUE_ON_FAILURE)

not_run: WebUI.click(findTestObject('Page_Auto-Billing/Page_Shipment Details/Add Record/ShipperCountryCode_clear'))

not_run: WebUI.click(findTestObject('Page_Auto-Billing/Page_Shipment Details/Add Record/ShipperCountryCode_dropdown'))

not_run: WebUI.setText(findTestObject('Page_Auto-Billing/Page_Shipment Details/Add Record/ShipperCountryCode_input'), 'SG')

not_run: WebUI.click(findTestObject('Page_Auto-Billing/Page_Shipment Details/Add Record/ShipperCityCode_dropdown'))

not_run: WebUI.verifyElementText(findTestObject('Page_Auto-Billing/Page_Shipment Details/Add Record/ShipperCountryCode_input - found'), 
    'SG')

not_run: WebUI.sendKeys(findTestObject('Page_Auto-Billing/Page_Shipment Details/Add Record/ShipperCityCode_input'), Keys.chord(
        Keys.DELETE), FailureHandling.CONTINUE_ON_FAILURE)

not_run: WebUI.click(findTestObject('Page_Auto-Billing/Page_Shipment Details/Add Record/ShipperCityCode_clear'))

not_run: WebUI.click(findTestObject('Page_Auto-Billing/Page_Shipment Details/Add Record/ShipperCityCode_dropdown'))

not_run: WebUI.setText(findTestObject('Page_Auto-Billing/Page_Shipment Details/Add Record/ShipperCityCode_input'), 'SIN')

not_run: WebUI.click(findTestObject('Page_Auto-Billing/Page_Shipment Details/Add Record/ShipperCountryCode_dropdown'))

not_run: WebUI.click(findTestObject('Page_Auto-Billing/Page_Shipment Details/Add Record/ShipperCountryCode_dropdown'))

not_run: WebUI.verifyElementText(findTestObject('Page_Auto-Billing/Page_Shipment Details/Add Record/ShipperCityCode_input - found'), 
    'SIN')
...
WebUI.sendKeys(findTestObject('Page_Auto-Billing/Page_Shipment Details/Add Record/ConsigneeCountryCode_input'), Keys.chord(
        Keys.DELETE), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('Page_Auto-Billing/Page_Shipment Details/Add Record/ConsigneeCountryCode_clear'))

WebUI.click(findTestObject('Page_Auto-Billing/Page_Shipment Details/Add Record/ConsigneeCountryCode_dropdown'))

WebUI.setText(findTestObject('Page_Auto-Billing/Page_Shipment Details/Add Record/ConsigneeCountryCode_input'), 'SG')
...
WebUI.sendKeys(findTestObject('Page_Auto-Billing/Page_Shipment Details/Add Record/ConsigneeCityCode_input'), Keys.chord(
        Keys.DELETE))

WebUI.click(findTestObject('Page_Auto-Billing/Page_Shipment Details/Add Record/ConsigneeCityCode_clear'))

WebUI.click(findTestObject('Page_Auto-Billing/Page_Shipment Details/Add Record/ConsigneeCityCode_dropdown'))

WebUI.setText(findTestObject('Page_Auto-Billing/Page_Shipment Details/Add Record/ConsigneeCityCode_input'), 'SIN')
...
not_run: WebUI.click(findTestObject('Page_Auto-Billing/Page_Shipment Details/Add Record/ConsigneeCityCode_dropdown'))

not_run: WebUI.verifyElementText(findTestObject('Page_Auto-Billing/Page_Shipment Details/Add Record/ConsigneeCountryCode_input - found'), 
...
not_run: WebUI.verifyElementText(findTestObject('Page_Auto-Billing/Page_Shipment Details/Add Record/ConsigneeCityCode_input - found'), 

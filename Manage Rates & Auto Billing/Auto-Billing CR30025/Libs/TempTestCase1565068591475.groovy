...
RunConfiguration.setExecutionSettingFile('C:\\Users\\DZAKYR~1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\AB CR30043\\2 Send FWB Message\\SN6_Send FWB Message with Flight Number is 3 Character (3 digits)\\20190806_121631\\execution.properties')
...
not_run: ((DriverFactory.getWebDriver()) as JavascriptExecutor).executeScript('$("#Origin").data("kendoDropDownList").select(1);')

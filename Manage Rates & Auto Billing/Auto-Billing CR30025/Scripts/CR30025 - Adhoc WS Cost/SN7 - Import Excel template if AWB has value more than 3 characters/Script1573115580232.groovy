...
WebUI.setText(findTestObject('Page_Manage Rates/2 Adhoc Quotation/AWBNumber'), '1234')

WebUI.delay(2)

not_run: CustomKeywords.'ccnpackage.UploadFile.uploadFile'(findTestObject('Page_Manage Rates/2 Adhoc Quotation/Import/btn_Browse'), 
    'D:\\Works\\Cargo Community Network Pte Ltd\\Documents\\AutoBilling + ManageRates\\CR30024_CR30025\\CR30024\\Test Data\\v2\\CR30024_25_TestData7.xlsx')

WebUI.delay(5)

not_run: WebUI.click(findTestObject('Page_Manage Rates/2 Adhoc Quotation/Import/btn_Upload'))

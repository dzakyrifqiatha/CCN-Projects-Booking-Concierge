...
WebUI.check(findTestObject('Page_Manage Rates/2 Adhoc Quotation/Import/checkbox_Overwrite Existing Records'))

WebUI.verifyElementChecked(findTestObject('Page_Manage Rates/2 Adhoc Quotation/Import/checkbox_Overwrite Existing Records'), 
    3)

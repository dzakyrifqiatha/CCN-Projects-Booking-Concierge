...
WebUI.setText(findTestObject('Page_Configurator 2.0/MessageToSend'), GlobalVariable.Message5)
...
WebUI.setText(findTestObject('Page_Auto-Billing/2 Section_Shipment Detail Dash/input_MAWB Number'), '618-63687352')

...
WebUI.click(findTestTObject('Page_Configurator 2.0/Nav_Send Message Tab - Dev - Kelvin'))

WebUI.setText(findTestObject('Page_Configurator 2.0/MessageToSend'), Message)
...
WebUI.click(findTestObject('Page_Auto-Billing/2 Section_Shipment Detail Dash/MAWBNumber-9'))

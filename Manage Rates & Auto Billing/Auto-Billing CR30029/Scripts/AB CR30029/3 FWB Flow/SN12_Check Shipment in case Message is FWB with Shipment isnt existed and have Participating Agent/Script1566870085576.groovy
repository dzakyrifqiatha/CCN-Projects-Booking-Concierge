...
WebUI.setText(findTestObject('Page_Configurator 2.0/MessageToSend'), GlobalVariable.Message12)
...
WebUI.click(findTestObject('Page_Auto-Billing/2 Section_Shipment Detail Dash/MAWBNumber-12'))

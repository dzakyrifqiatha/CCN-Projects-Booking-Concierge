...
WebUI.setText(findTestObject('Page_Configurator 2.0/MessageToSend'), GlobalVariable.Message2)
...
WebUI.callTestCase(findTestCase('Login - PPD/1 Login PPD (Airline)'), [:])
...
WebUI.setText(findTestObject('Page_Auto-Billing/2 Section_Shipment Detail Dash/input_MAWB Number'), '706-63687400')

WebUI.delay(3)

not_run: WebUI.sendKeys(findTestObject('Page_Auto-Billing/2 Section_Shipment Detail Dash/input_MAWB Number'), Keys.chord(
        Keys.RETURN), FailureHandling.OPTIONAL)
...
WebUI.click(findTestObject('Page_Auto-Billing/2 Section_Shipment Detail Dash/MAWBNumber-2'))

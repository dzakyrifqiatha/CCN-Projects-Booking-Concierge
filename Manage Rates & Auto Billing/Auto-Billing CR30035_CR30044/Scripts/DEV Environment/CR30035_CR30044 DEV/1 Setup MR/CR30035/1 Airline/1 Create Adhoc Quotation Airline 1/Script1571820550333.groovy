...
not_run: for (def row = 1; row <= findTestData('CR30035/1 Airline/1 Adhoc Quotation').getRowNumbers(); row++) {
    ...
    WebUI.setText(findTestObject('Page_Manage Rates/2 Adhoc Quotation/1 Other Charges/input_Rate Type'), findTestData('CR30035/1 Airline/1 Adhoc Quotation').getValue(
            'Rate Type', row))
    ...
    WebUI.setText(findTestObject('Page_Manage Rates/2 Adhoc Quotation/1 Other Charges/input_Quantity'), findTestData('CR30035/1 Airline/1 Adhoc Quotation').getValue(
            'Quantity', row))

    WebUI.setText(findTestObject('Page_Manage Rates/2 Adhoc Quotation/1 Other Charges/input_Sales Rate'), findTestData('CR30035/1 Airline/1 Adhoc Quotation').getValue(
            'Sales Rate', 'row'))
...
WebUI.setText(findTestObject('Page_Manage Rates/2 Adhoc Quotation/Page_/input_Charge Code_cbChargeCode'), findTestData('CR30035/1 Airline/1 Adhoc Quotation').getValue(
        'Charge Code', row))

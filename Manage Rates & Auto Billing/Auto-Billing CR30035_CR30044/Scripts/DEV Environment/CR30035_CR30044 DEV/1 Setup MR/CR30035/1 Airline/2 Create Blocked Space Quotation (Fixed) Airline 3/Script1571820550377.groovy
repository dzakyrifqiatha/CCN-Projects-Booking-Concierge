...
for (def row = 1; row <= findTestData('CR30035/1 Airline/2 Blocked Space (Fixed) Quotation'); row++) {
    ...
    WebUI.setText(findTestObject('Page_Manage Rates/3 Blocked Space Quotation (Fixed)/Page_/input_Weight UOM_cbWeightUOM'), 
        findTestData('CR30035/1 Airline/2 Blocked Space (Fixed) Quotation').getValue('Other UOM', row))

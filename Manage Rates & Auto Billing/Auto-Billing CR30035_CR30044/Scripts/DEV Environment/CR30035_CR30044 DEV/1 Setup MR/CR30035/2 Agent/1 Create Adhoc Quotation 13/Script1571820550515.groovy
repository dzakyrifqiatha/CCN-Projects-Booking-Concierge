...
for (def row = 1; row <= findTestData('CR30035/2 Agent/1 Adhoc Quotation').getRowNumbers(); row++) {
    ...
    WebUI.setText(findTestObject('Page_Manage Rates/2 Adhoc Quotation/Page_/input_Charge Code_cbChargeCode'), findTestData(
            'CR30035/2 Agent/1 Adhoc Quotation').getValue('Charge Code', row))
    ...
    WebUI.setText(findTestObject('Page_Manage Rates/2 Adhoc Quotation/1 Other Charges/input_Rate Type'), findTestData('CR30035/2 Agent/1 Adhoc Quotation').getValue(
            'Rate Type', row))
    ...
    WebUI.setText(findTestObject('Page_Manage Rates/2 Adhoc Quotation/1 Other Charges/input_Quantity'), findTestData('CR30035/2 Agent/1 Adhoc Quotation').getValue(
            'Quantity', row))

    WebUI.setText(findTestObject('Page_Manage Rates/2 Adhoc Quotation/Page_/input_Cost Rate'), findTestData('CR30035/2 Agent/1 Adhoc Quotation').getValue(
            'Cost Rate', row))

    WebUI.setText(findTestObject('Page_Manage Rates/2 Adhoc Quotation/Page_/input_Other UOM_cbOtherUOM'), findTestData('CR30035/2 Agent/1 Adhoc Quotation').getValue(
            'Sales Rate', 'row'))

    WebUI.setText(findTestObject('Page_Manage Rates/2 Adhoc Quotation/Page_/input_Cost Tax_txtCostTax'), findTestData('CR30035/2 Agent/1 Adhoc Quotation').getValue(
            'Cost Tax', row))
...
not_run: WebUI.setText(findTestObject('Page_Manage Rates/2 Adhoc Quotation/1 Other Charges/input_Rate Type'), findTestData(
        'CR30035/Adhoc QT Details').getValue('vRateType', row))
...
not_run: WebUI.setText(findTestObject('Page_Manage Rates/2 Adhoc Quotation/1 Other Charges/input_Quantity'), findTestData(
        'CR30035/Adhoc QT Details').getValue('vQuantity', row))

not_run: WebUI.setText(findTestObject('Page_Manage Rates/2 Adhoc Quotation/Page_/input_Cost Rate'), findTestData('CR30035/Adhoc QT Details').getValue(
        'vCostRate', row))

not_run: WebUI.setText(findTestObject('Page_Manage Rates/2 Adhoc Quotation/Page_/input_Other UOM_cbOtherUOM'), findTestData(
        'CR30035/Adhoc QT Details').getValue('vSalesRate', 'row'))

not_run: WebUI.setText(findTestObject('Page_Manage Rates/2 Adhoc Quotation/Page_/input_Cost Tax_txtCostTax'), findTestData(
        'CR30035/Adhoc QT Details').getValue('vCostTax', row))

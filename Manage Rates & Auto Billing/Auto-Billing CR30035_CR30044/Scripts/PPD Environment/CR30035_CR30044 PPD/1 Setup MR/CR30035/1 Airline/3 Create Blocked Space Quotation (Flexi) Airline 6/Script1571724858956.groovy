...
for (def row = 1; row <= findTestData('CR30035/1 Airline/3 Blocked Space (Flexi) Quotation').getRowNumbers(); row++) {
	
	WebUI.click(findTestObject('Page_Manage Rates/3 Blocked Space Quotation (Flexi)/Page_/input_Freight Sectors_ctl00ctl00ContentPlaceHolderSubPageContentFreightSectorsbtnAdd'))
	
	WebUI.delay(10)
	
	WebUI.setText(findTestObject('Page_Manage Rates/3 Blocked Space Quotation (Fixed)/Page_/input_Carrier Code_cbAirlineID'), findTestData(
            'CR30035/1 Airline/2 Blocked Space (Flexi) Quotation').getValue('Carrier Code', row))
	
	WebUI.delay(3)
	
	WebUI.click(findTestObject('Page_Manage Rates/3 Blocked Space Quotation (Fixed)/Page_/input_Carrier Code - found'), FailureHandling.STOP_ON_FAILURE)
	
	WebUI.delay(2)
	
	WebUI.setText(findTestObject('Page_Manage Rates/3 Blocked Space Quotation (Fixed)/Page_/input_Flight Number'), findTestData(
            'CR30035/1 Airline/2 Blocked Space (Flexi) Quotation').getValue('Flight Number', row))
	
	WebUI.delay(3)
	
	WebUI.setText(findTestObject('Page_Manage Rates/3 Blocked Space Quotation (Fixed)/Page_/input_Origin_cbOrigin'), findTestData(
            'CR30035/1 Airline/2 Blocked Space (Flexi) Quotation').getValue('Origin', row))
	...
	WebUI.setText(findTestObject('Page_Manage Rates/3 Blocked Space Quotation (Fixed)/Page_/input_Destination_cbDestination'), findTestData(
            'CR30035/1 Airline/2 Blocked Space (Flexi) Quotation').getValue('Destination', row))
	...
	WebUI.setText(findTestObject('Page_Manage Rates/3 Blocked Space Quotation (Fixed)/Page_/input_Currency_cbCurrency'), findTestData(
            'CR30035/1 Airline/2 Blocked Space (Flexi) Quotation').getValue('Currency', row))
	...
	WebUI.setText(findTestObject('Page_Manage Rates/3 Blocked Space Quotation (Fixed)/Page_/input_Weight UOM_cbWeightUOM'), findTestData(
            'CR30035/1 Airline/2 Blocked Space (Flexi) Quotation').getValue('Weight UOM', row))
	...
	WebUI.setText(findTestObject('Page_Manage Rates/3 Blocked Space Quotation (Fixed)/Page_/input_Cargo Class_cbCargoClass'), findTestData(
            'CR30035/1 Airline/2 Blocked Space (Flexi) Quotation').getValue('Cargo Class', row))
	...
	WebUI.setText(findTestObject('Page_Manage Rates/3 Blocked Space Quotation (Fixed)/Page_/input_Allocated Weight_txtAllocatedWeight'), findTestData(
            'CR30035/1 Airline/2 Blocked Space (Flexi) Quotation').getValue('Allocated Weight', row))
	
	WebUI.delay(3)
	
	WebUI.setText(findTestObject('Page_Manage Rates/3 Blocked Space Quotation (Fixed)/Page_/input_Rate Per KGM_txtRatePerKGM'), findTestData(
            'CR30035/1 Airline/2 Blocked Space (Flexi) Quotation').getValue('Rate Per KGM', row))
	...
	WebUI.setText(findTestObject('Page_Manage Rates/3 Blocked Space Quotation (Fixed)/Page_/input_ULD Code'), findTestData(
            'CR30035/1 Airline/2 Blocked Space (Flexi) Quotation').getValue('ULD Code', row))
	...
	WebUI.setText(findTestObject('Page_Manage Rates/3 Blocked Space Quotation (Fixed)/Page_/input_Pivot Weight'), findTestData(
            'CR30035/1 Airline/2 Blocked Space (Flexi) Quotation').getValue('Pivot Weight', row))
	...
	WebUI.setText(findTestObject('Page_Manage Rates/3 Blocked Space Quotation (Fixed)/Page_/input_Rate per ULD'), findTestData(
            'CR30035/1 Airline/2 Blocked Space (Flexi) Quotation').getValue('Rate Per ULD', row))
	...
	WebUI.setText(findTestObject('Page_Manage Rates/3 Blocked Space Quotation (Fixed)/Page_/input_Quantity'), findTestData(
            'CR30035/1 Airline/2 Blocked Space (Flexi) Quotation').getValue('Quantity', row))

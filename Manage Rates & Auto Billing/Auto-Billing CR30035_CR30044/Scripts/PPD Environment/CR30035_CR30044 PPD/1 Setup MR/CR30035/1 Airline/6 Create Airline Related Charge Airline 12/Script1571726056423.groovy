...
WebUI.setText(findTestObject('Page_Manage Rates/Contract Quotation/Add Contract Quotation/Airline Related - Add Record/Page_/input_Carrier Code_cbAirlineID'), findTestData('CR30035/1 Airline/6 Airline Related Charge').getValue('Carrier Code', row))

WebUI.delay(3)

WebUI.setText(findTestObject('Page_Manage Rates/Contract Quotation/Add Contract Quotation/Airline Related - Add Record/Page_/input_Charge Code_cbChargeCode'), findTestData('CR30035/1 Airline/6 Airline Related Charge').getValue('Charge Code', row))

WebUI.delay(3)

WebUI.setText(findTestObject('Page_Manage Rates/Contract Quotation/Add Contract Quotation/Airline Related - Add Record/Page_/input_Cargo Class_cbCargoClass'), findTestData('CR30035/1 Airline/6 Airline Related Charge').getValue('Cargo Class', row))

WebUI.delay(3)

WebUI.setText(findTestObject('Page_Manage Rates/Contract Quotation/Add Contract Quotation/Airline Related - Add Record/Page_/input_Handling Code_cbHandlingCode'), findTestData('CR30035/1 Airline/6 Airline Related Charge').getValue('Handling Code', row))

WebUI.delay(3)

WebUI.setText(findTestObject('Page_Manage Rates/Contract Quotation/Add Contract Quotation/Airline Related - Add Record/Page_/input_Weight UOM_cbWeightUOM'), findTestData('CR30035/1 Airline/6 Airline Related Charge').getValue('Weight UOM', row))

WebUI.delay(3)

WebUI.setText(findTestObject('Page_Manage Rates/Contract Quotation/Add Contract Quotation/Airline Related - Add Record/Page_/input_Weight Type_cbWeightType'), findTestData('CR30035/1 Airline/6 Airline Related Charge').getValue('Weight Type', row))
...
WebUI.setText(findTestObject('Page_Manage Rates/Contract Quotation/Add Contract Quotation/Airline Related - Add Record/Page_/input_ImportExport_cbImportExport'), findTestData('CR30035/1 Airline/6 Airline Related Charge').getValue('Import/Export', row))

WebUI.delay(3)

WebUI.setText(findTestObject('Page_Manage Rates/Contract Quotation/Add Contract Quotation/Airline Related - Add Record/Page_/input_Origin_cbOriginDestination'), findTestData('CR30035/1 Airline/6 Airline Related Charge').getValue('Origin/Destination', row))

WebUI.delay(3)

WebUI.setText(findTestObject('Page_Manage Rates/Contract Quotation/Add Contract Quotation/Airline Related - Add Record/Page_/input_Rate Type_cbRateType'), findTestData('CR30035/1 Airline/6 Airline Related Charge').getValue('Rate Type', row))

WebUI.delay(3)

WebUI.setText(findTestObject('Page_Manage Rates/Contract Quotation/Add Contract Quotation/Airline Related - Add Record/Page_/input_MinStd Sell Amt_txtMinStdSellAmount'), findTestData('CR30035/1 Airline/6 Airline Related Charge').getValue('Min/Std Amount', row))
...
WebUI.setText(findTestObject('Page_Manage Rates/Contract Quotation/Add Contract Quotation/Airline Related - Add Record/Page_/input_WeightBreak'), findTestData('CR30035/1 Airline/6 Airline Related Charge').getValue('Weight Break', row))

WebUI.setText(findTestObject('Page_Manage Rates/Contract Quotation/Add Contract Quotation/Airline Related - Add Record/Page_/input_Amount'), findTestData('CR30035/1 Airline/6 Airline Related Charge').getValue('Amount', row))

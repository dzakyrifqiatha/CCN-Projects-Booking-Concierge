...
for (def row = 1; row <= findTestData('CR30035/3 GSA/1 Adhoc Quotation').getRowNumbers(); row++) {
    ...
    WebUI.setText(findTestObject('Page_Manage Rates/2 Adhoc Quotation/Page_/input_Charge Code_cbChargeCode'), findTestData(
            'CR30035/3 GSA/1 Adhoc Quotation').getValue(vChargeCode, row))
    ...
    WebUI.setText(findTestObject('Page_Manage Rates/2 Adhoc Quotation/1 Other Charges/input_Rate Type'), findTestData('CR30035/3 GSA/1 Adhoc Quotation').getValue(
            vRateType, row))
    ...
    WebUI.setText(findTestObject('Page_Manage Rates/2 Adhoc Quotation/1 Other Charges/input_Quantity'), findTestData('CR30035/3 GSA/1 Adhoc Quotation').getValue(
            vQuantity, row))

    WebUI.setText(findTestObject('Page_Manage Rates/2 Adhoc Quotation/Page_/input_Sales Rate'), findTestData('CR30035/3 GSA/1 Adhoc Quotation').getValue(
            vSalesRate, row))

    WebUI.setText(findTestObject('Page_Manage Rates/2 Adhoc Quotation/Page_/input_Cost Amount_txtCostAmount'), findTestData('CR30035/3 GSA/1 Adhoc Quotation').getValue(
			vCostAmount, row))

    WebUI.setText(findTestObject('Page_Manage Rates/2 Adhoc Quotation/Page_/input_Other UOM_cbOtherUOM'), findTestData('CR30035/3 GSA/1 Adhoc Quotation').getValue(
            vOtherUOM, row))

    WebUI.setText(findTestObject('Page_Manage Rates/2 Adhoc Quotation/Page_/input_Sales Tax_txtSalesTax'), findTestData('CR30035/3 GSA/1 Adhoc Quotation').getValue(
			vSalesTax, row))

    WebUI.setText(findTestObject('Page_Manage Rates/2 Adhoc Quotation/Page_/input_Cost Tax_txtCostTax'), findTestData('CR30035/3 GSA/1 Adhoc Quotation').getValue(
            vCostTax, row))
...
not_run: WebUI.setText(findTestObject('Page_Manage Rates/2 Adhoc Quotation/1 Other Charges/input_Rate Type'), findTestData(
        'CR30035/3 GSA/1 Adhoc Quotation').getValue('vRateType', row))
...
not_run: WebUI.setText(findTestObject('Page_Manage Rates/2 Adhoc Quotation/1 Other Charges/input_Quantity'), findTestData(
        'CR30035/3 GSA/1 Adhoc Quotation').getValue('vQuantity', row))

not_run: WebUI.setText(findTestObject('Page_Manage Rates/2 Adhoc Quotation/Page_/input_Cost Rate'), findTestData('CR30035/3 GSA/1 Adhoc Quotation').getValue(
        vCostRate, row))

not_run: WebUI.setText(findTestObject('Page_Manage Rates/2 Adhoc Quotation/Page_/input_Other UOM_cbOtherUOM'), findTestData(
        'CR30035/3 GSA/1 Adhoc Quotation').getValue(vOtherUOM, row))

not_run: WebUI.setText(findTestObject('Page_Manage Rates/2 Adhoc Quotation/Page_/input_Cost Tax_txtCostTax'), findTestData(
        'CR30035/3 GSA/1 Adhoc Quotation').getValue(vCostTax, row))

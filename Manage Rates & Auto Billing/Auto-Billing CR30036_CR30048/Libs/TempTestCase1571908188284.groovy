...
RunConfiguration.setExecutionSettingFile('C:\\Users\\DZAKYR~1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\PPD Environment\\CR30036 - Contracts Rate upload for Agent\\SN0d - Input invalid file into MR\\20191024_170948\\execution.properties')
...
CustomKeywords.'ccnpackage.UnorderedListnumber.uploadFile'(findTestObject('Page_Manage Rates/3 Freight - Contract/Import/btn_Browse File'), 
    'D:\\\\Work\\\\5 CCN\\\\Documents\\\\3 MR + AB\\\\CR30036_CR30048\\\\CR30048\\\\Test Data v1.0\\\\Upload to MR\\\\SN0d - filled.xlsx')

WebUI.delay(5)

WebUI.click(findTestObject('Page_Manage Rates/3 Freight - Contract/input_DropZone_btnUpload'))

''', 'Test Cases/PPD Environment/CR30036 - Contracts Rate upload for Agent/SN0d - Input invalid file into MR', new TestCaseBinding('Test Cases/PPD Environment/CR30036 - Contracts Rate upload for Agent/SN0d - Input invalid file into MR',[:]), FailureHandling.STOP_ON_FAILURE , false)

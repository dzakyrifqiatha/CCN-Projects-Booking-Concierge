...
WebUI.setText(findTestObject('Page_Manage Rates/3 Freight - Contract/input_RadDatePicker_EffectiveDatedateInput'), '01/09/2019')

WebUI.setText(findTestObject('Page_Manage Rates/3 Freight - Contract/input_RadDatePicker_ExpiryDatedateInput'), '30/09/2019')
...
CustomKeywords.'ccnpackage.UnorderedListnumber.uploadFile'(findTestObject('Page_Manage Rates/3 Freight - Contract/Import/btn_Browse File'), 
    'D:\\Work\\5 CCN\\Documents\\3 MR + AB\\CR30036_CR30048\\CR30048\\Test Data v1.0\\Upload to MR\\SN0a.xlsx')

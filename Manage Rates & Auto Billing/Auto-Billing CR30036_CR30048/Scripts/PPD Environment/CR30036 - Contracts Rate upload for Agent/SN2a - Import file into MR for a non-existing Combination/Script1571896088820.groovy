...
WebUI.setText(findTestObject('Page_Manage Rates/3 Freight - Contract/input_Vendor Code'), 'GA')

WebUI.click(findTestObject('Page_Manage Rates/3 Freight - Contract/input_Vendor Code - found LH'))
...
WebUI.setText(findTestObject('Page_Manage Rates/3 Freight - Contract/input_RadDatePicker_EffectiveDatedateInput'), '01/01/2020')

WebUI.setText(findTestObject('Page_Manage Rates/3 Freight - Contract/input_RadDatePicker_ExpiryDatedateInput'), '31/01/2020')

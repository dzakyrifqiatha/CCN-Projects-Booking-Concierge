...
WebUI.setText(findTestObject('Page_Manage Rates/3 Freight - Contract/input_Vendor Code'), 'TST')

WebUI.click(findTestObject('Page_Manage Rates/3 Freight - Contract/input_Vendor Code - found TST'))

not_run: WebUI.sendKeys(findTestObject('Page_Manage Rates/3 Freight - Contract/input_Vendor Code'), Keys.ENTER)
...
WebUI.click(findTestObject('Page_Manage Rates/3 Freight - Contract/input_ShipperConsignee - found'))
...
WebUI.check(findTestObject('Page_Manage Rates/3 Freight - Contract/Import/checkbox_Include M and N Rate'))
...
CustomKeywords.'ccnpackage.UnorderedListnumber.uploadFile'(findTestObject('Page_Manage Rates/3 Freight - Contract/Import/btn_Browse File'), 
    'D:\\Work\\5 CCN\\Documents\\3 MR + AB\\CR30036_CR30048\\CR30048\\Test Data v1.0\\Upload to MR\\SN4 - CR30036R1C DHL Corrected-I.xlsx')

...
WebUI.sendKeys(findTestObject('Page_Configurator 2.0/MessageToSend'), GlobalVariable.Message8)
...
WebUI.selectOptionByValue(findTestObject('Page_Configurator 2.0/Tab_Query/dropDown_Receive Date'), 'Last5days', false)
...
WebUI.setText(findTestObject('Page_Configurator 2.0/Tab_Query/input_AWB Suffix'), '63687396')

...
WebUI.sendKeys(findTestObject('Page_Configurator 2.0/MessageToSend'), GlobalVariable.Message9)
...
WebUI.verifyTextPresent('<FlightNumber>0456A</FlightNumber>', false)

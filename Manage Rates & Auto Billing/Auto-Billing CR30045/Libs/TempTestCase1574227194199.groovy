...
RunConfiguration.setExecutionSettingFile('C:\\Users\\DZAKYR~1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\AB CR30045 - PPD\\3 FWB Flow\\SN1 - Send FWB with Flight Date value same as Issue Date\\20191120_131954\\execution.properties')
...
''', 'Test Cases/AB CR30045 - PPD/3 FWB Flow/SN1 - Send FWB with Flight Date value same as Issue Date', new TestCaseBinding('Test Cases/AB CR30045 - PPD/3 FWB Flow/SN1 - Send FWB with Flight Date value same as Issue Date',[:]), FailureHandling.STOP_ON_FAILURE , false)

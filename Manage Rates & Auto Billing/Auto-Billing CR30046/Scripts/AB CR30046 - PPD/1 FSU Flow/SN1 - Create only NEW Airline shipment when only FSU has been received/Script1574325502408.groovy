...
WebUI.callTestCase(findTestCase('Open New Tab'), [('path') : 'http://ppdlogin.ccnhub.com/LINC'], null)

WebUI.callTestCase(findTestCase('Login - PPD/1 Login PPD (Airline SQ) - SIN'), [:])

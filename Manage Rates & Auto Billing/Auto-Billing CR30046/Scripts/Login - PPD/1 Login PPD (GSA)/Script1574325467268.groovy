...
'LINC Login'
not_run: WebUI.openBrowser('https://ppdlogin.ccnhub.com/LINC/')
...
WebUI.setText(findTestObject('Page_CCNhub LINC/input_ctl00ContentTxtEmail(real_input)'), 'CCNTECHGSA.CCNUser1@CCNhub.com')

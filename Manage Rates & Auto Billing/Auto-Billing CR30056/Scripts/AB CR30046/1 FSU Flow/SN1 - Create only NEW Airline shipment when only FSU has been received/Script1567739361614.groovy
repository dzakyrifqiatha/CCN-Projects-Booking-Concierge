...
'call test case Open New Tab for opening the CCNhub LINC'
WebUI.callTestCase(findTestCase('Open New Tab'), [('path') : 'http://devlogin.ccnhub.com/LINC'], null)

WebUI.callTestCase(findTestCase('Login/1 Login DEV (Airline SQ) - SIN'), [:])
...
WebUI.setText(findTestObject('Page_Auto-Billing/Page_Shipment Details/MAWBNumber_input'), '618-63687345')

WebUI.click(findTestObject('Page_Auto-Billing/Page_Shipment Details/Search_button'))

WebUI.delay(3)

WebUI.click(findTestObject('Page_Auto-Billing/Page_Shipment Details/MAWB_List - found'))
...
WebUI.callTestCase(findTestCase('Login/1 Login DEV (GSA)'), [:], FailureHandling.STOP_ON_FAILURE)

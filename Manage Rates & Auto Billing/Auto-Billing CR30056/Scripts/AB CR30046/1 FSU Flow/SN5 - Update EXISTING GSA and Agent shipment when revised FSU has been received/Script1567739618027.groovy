...
WebUI.callTestCase(findTestCase('Open New Tab'), [('path') : 'http://devlogin.ccnhub.com/LINC'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Page_Auto-Billing/Page_Shipment Details/MAWBNumber_input'), '706-63687899')

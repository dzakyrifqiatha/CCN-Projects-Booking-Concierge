...
WebUI.callTestCase(findTestCase('Login/1 Login DEV (Airline SQ) - BJS'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Page_Auto-Billing/Page_Shipment Details/MAWBNumber_input'), '618-71530666')
...
WebUI.callTestCase(findTestCase('Login/1 Login DEV (Agent DHL)'), [:], FailureHandling.STOP_ON_FAILURE)
...
not_run: WebUI.callTestCase(findTestCase('Open New Tab'), [('path') : 'devlogin.ccnhub.com/LINC'], FailureHandling.STOP_ON_FAILURE)

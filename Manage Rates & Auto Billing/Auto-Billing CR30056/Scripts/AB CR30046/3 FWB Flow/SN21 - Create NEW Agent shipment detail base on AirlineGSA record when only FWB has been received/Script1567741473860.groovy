...
WebUI.setText(findTestObject('Page_Auto-Billing/Page_Shipment Details/MAWBNumber_input'), '618-71530222')
...
WebUI.callTestCase(findTestCase('Login/1 Login DEV (Agent DHL) - BJS'), [:], FailureHandling.STOP_ON_FAILURE)
...
not_run: WebUI.callTestCase(findTestCase('Open New Tab'), [:], FailureHandling.STOP_ON_FAILURE)

...
WebUI.setText(findTestObject('Page_BC Common Login Page/input_Email Address_email (Common Login)'), 'testingdev1223@yopmail.com')
...
if (WebUI.verifyTextPresent('Account is not active. Please check you email account to activate it. (We recommend checking your spam or junk folder if you do not see the email, and mark Booking Concierge as a safe sender.)', 
    false)) {
...
WebUI.setText(findTestObject('Page_BC Common Login Page/input_Email Address_email (Common Login)'), 'testingdevbc38274623@yopmail.com')

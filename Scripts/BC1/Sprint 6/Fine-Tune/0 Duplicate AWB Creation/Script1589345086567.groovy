...
WebUI.setText(findTestObject('Page_Create New Booking/input_Special Handling Codes 4'), var_shc4)
...
WebUI.setText(findTestObject('Page_Create New Booking/input__mat-input-Off Point'), var_OffPoint)

...
WebUI.setText(findTestObject('Page_Create New Booking/input_Special Handling Codes 2'), var_shc2)

WebUI.setText(findTestObject('Page_Create New Booking/input_Special Handling Codes 3'), var_shc3)
...
WebUI.setText(findTestObject('Page_Create New Booking/input_Volume_mat-input-Pieces'), var_fBoardPoint)

WebUI.setText(findTestObject('Page_Create New Booking/input_Volume_mat-input-Weight'), var_fOffPoint)

...
if (CB_CommodityInfo == 'Yes'){
	WebUI.click(findTestObject('Object Repository/BC/Create Booking/input_Commodity Info'))
	
	WebUI.click(findTestObject('Object Repository/BC/Create Booking/span_SQ Testing Commodity Info'))
}

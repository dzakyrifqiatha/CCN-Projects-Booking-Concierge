...
response = WS.sendRequest(findTestObject('BOXService/Delete Document', [('documentID') : findTestData('BOXService/TD_BoxDocument').getValue(
                9, 1), ('documentVersionID') : findTestData('BOXService/TD_BoxDocument').getValue(10, 1)]))

...
WebUI.click(findTestObject('OLD-Obsolete/BQ/Page_BCBookingQueue/Page_BCBookingQueue/flightSection_edit row 1'))

WebUI.setText(findTestObject('OLD-Obsolete/BQ/Page_BCBookingQueue/Page_BCBookingQueue/input_Departure'), 'SIN')

WebUI.setText(findTestObject('OLD-Obsolete/BQ/Page_BCBookingQueue/Page_BCBookingQueue/input_Arrival'), 'KUL')

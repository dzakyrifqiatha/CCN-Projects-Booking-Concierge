...
WebUI.callTestCase(findTestCase('OLD-Obsolete/Authentication Login/Login - New DEV Server'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('OLD-Obsolete/BC1/Sprint 1/Registration Process/2 Registration Failed - Check Field'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('OLD-Obsolete/BC1/Sprint 1/Registration Process/0 Registration Success'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('OLD-Obsolete/BC1/Sprint 1/Registration Process/1 Registration Failed - Email Existed'), [:], FailureHandling.STOP_ON_FAILURE)

...
if (Test_DG == 'Yes') {
    WebUI.callTestCase(findTestCase('OLD-Obsolete/Regression Testing/1 BC Portal Admin/4.1 Density Group'), [('Test_No') : findTestData('Regression - BC Portal Admin').getValue('Test_No', 'GlobalVariable.G_TestRowNo')

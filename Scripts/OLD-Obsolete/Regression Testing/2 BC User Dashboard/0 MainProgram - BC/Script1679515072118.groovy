...
if (Test_Reg_Email == 'Yes') {
    WebUI.callTestCase(findTestCase('OLD-Obsolete/Regression Testing/2 BC User Dashboard/1 Registration'), [('Test_No') : findTestData('Regression').getValue(
...
if (Test_Log_Email == 'Yes') {
    WebUI.callTestCase(findTestCase('OLD-Obsolete/Regression Testing/2 BC User Dashboard/2 Login'), [('Test_No') : findTestData('Regression').getValue('Test_No', 
...
//    WebUI.callTestCase(findTestCase('OLD-Obsolete/Regression Testing/2 BC User Dashboard/3.2 CreateAirline'), [('Test_No') : findTestData('Regression').getValue(
...
//
//if (Test_Group == 'Yes') {
//    WebUI.callTestCase(findTestCase('OLD-Obsolete/Regression Testing/2 BC User Dashboard/4.2 GroupManagement'), [('Test_No') : findTestData('Regression').getValue('Test_No', GlobalVariable.G_TestRowNo)

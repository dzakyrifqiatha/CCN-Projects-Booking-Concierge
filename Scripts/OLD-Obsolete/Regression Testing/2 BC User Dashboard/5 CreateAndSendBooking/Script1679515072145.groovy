...
WebUI.verifyElementText(findTestObject('OLD-Obsolete/BC/Create Booking/Agent Information/AgentIfo_Company'), 'DHL GLOBAL FORWARDING SINGAPORE PT')

WebUI.verifyElementText(findTestObject('OLD-Obsolete/BC/Create Booking/Agent Information/AgentIfo_Station'), 'SIN')

WebUI.verifyElementText(findTestObject('OLD-Obsolete/BC/Create Booking/Agent Information/AgentIfo_IATA Code'), '3231696')

WebUI.verifyElementText(findTestObject('OLD-Obsolete/BC/Create Booking/Agent Information/AgentIfo_CASS Code'), '0000')

WebUI.verifyElementText(findTestObject('OLD-Obsolete/BC/Create Booking/Agent Information/AgentInfo_Account No'), '1234567')

WebUI.click(findTestObject('Page_Create Booking/button_add Flight Section'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('OLD-Obsolete/BC/Create Booking/Flight Section/input_F_CarrierCode'), CB_F_Carrier)

WebUI.setText(findTestObject('OLD-Obsolete/BC/Create Booking/Flight Section/input_F_FlightNumber'), CB_F_Number)

WebUI.setText(findTestObject('OLD-Obsolete/BC/Create Booking/Flight Section/input_F_FlightDate'), CB_F_Date)

WebUI.setText(findTestObject('OLD-Obsolete/BC/Create Booking/Flight Section/input_F_Departure'), CB_F_Dep)

WebUI.setText(findTestObject('OLD-Obsolete/BC/Create Booking/Flight Section/input_F_Arrival'), CB_F_Arrival)

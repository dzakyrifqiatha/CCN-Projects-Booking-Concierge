...
if (Airline_CEDI == 'Yes') {
    WebUI.verifyElementChecked(findTestObject(findTestObject('Object Repository/Page_BC My Airlines/Page_Create Airline/div_EDI Checkbox')), 
        2)
}

if (Airline_CEmail == 'Yes') {
    WebUI.verifyElementChecked(findTestObject(findTestObject('Object Repository/Page_BC My Airlines/Page_Create Airline/div_Email Checkbox')), 
        2)
}

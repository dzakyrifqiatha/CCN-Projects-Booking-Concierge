...
//WebUI.waitElementPresent(findTestObject('Page_Booking Concierge Homepage/h1_My Bookings', 1))

if (WebUI.verifyElementPresent('Page_Booking Concierge Homepage/h1_My Bookings', 1)) {

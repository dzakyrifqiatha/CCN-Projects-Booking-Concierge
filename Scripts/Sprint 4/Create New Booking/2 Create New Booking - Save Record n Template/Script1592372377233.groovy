...
WebUI.setText(findTestObject('Page_Create New Booking/input_Volume_mat-input-Weight'), findTestData('Booking/TestData_Flight').getValue(
        17, 1))
...
WebUI.setText(findTestObject('Page_Create New Booking/textarea_Remarks_Booking'), 'Test - Save Record & Template')

...
WebUI.setText(findTestObject('Page_Create New Booking/input_Special Handling Codes 3'), var_sch3)

WebUI.setText(findTestObject('Page_Create New Booking/input_Special Handling Codes 4'), var_sch4)

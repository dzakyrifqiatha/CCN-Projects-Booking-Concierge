...
WebUI.setText(findTestObject('Page_Create New Booking/input_Volume_mat-input-Pieces'), var_dHeight)
...
WebUI.setText(findTestObject('Page_Create New Booking/textarea_Remarks_Booking'), 'Test - Send from template')

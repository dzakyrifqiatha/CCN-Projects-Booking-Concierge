...
WebUI.setText(findTestObject('Page_Create New Booking/input__mat-input-Good Description'), var_pieces)

WebUI.setText(findTestObject('Page_Create New Booking/input__mat-input-Pieces'), var_weight)
